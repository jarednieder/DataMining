...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		FromFileLogLineGenerator<User, Article, Boolean> generator = new FromFileLogLineGenerator<User, Article, Boolean>(
				reader);

		ContextualBanditPolicy<User, Article, Boolean> policy = new MyPolicy(
				"./data/articles.txt");
