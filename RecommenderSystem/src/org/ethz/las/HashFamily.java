...
public class HashFamily {
	...
	public static SimpleHashFunction[] generateSimpleHashFamily(int maxCoef,
			int mod, int nHashFunctions, int seed) {
	...
	public static VectorHashFunction[] generateVectorHashFamily(int maxCoef,
			int length, int nHashFunctions, int seed) {
		Random R = new Random(seed);
